...
Detailed command references for each tool.
...
| [youtube-cli](./youtube-cli.md) | Manage YouTube Shorts - upload, list, clone, update |
...
See [CLAUDE.md](../CLAUDE.md) for a quick command overview.
